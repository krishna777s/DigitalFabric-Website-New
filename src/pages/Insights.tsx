...
const insightsData = [
  ...
  },
  {
    image: img3,
    title:
      "Strategic Investment Analysis for Logistics Tech Covering Global Startup Distribution and Early-Stage Funding",
    link: pdf3,
  },
  {
    image: img4,
    title:
      "Strategic Investment Analysis for Payment Tech Covering Global Funding Trends and India Financial Benchmarks",
    link: pdf4,
  },
  {
    image: img5,
...
const Insights = () => {
  ...
  return (
    <main className="min-h-screen bg-white">
      <section
        id="insights-domains"
        className="relative overflow-hidden bg-white pt-[120px] pb-16 sm:pb-20 md:pb-24 text-[#141742]"
      >
