  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto grid grid-cols-[0.85fr_1.15fr] max-[900px]:grid-cols-1 gap-12 items-center justify-start">
        ...
        >
          <p className="font-serif text-[clamp(1.25rem,1.7vw,1.55rem)] leading-[1.45] text-[#151c36] font-normal m-0 max-[640px]:text-[1.1rem]">
            The <strong className="font-extrabold text-[#10172e]">DIGITALFABRIC&reg; AISWITCH<sup className="text-[0.6em] relative top-[-0.35em] ml-[2px]">™</sup> Framework</strong> is a comprehensive, strategic approach to managing AI integration across key areas of business operations. The framework emphasizes six essential management pillars:
          </p>

          <p className="font-serif text-[clamp(1.25rem,1.7vw,1.55rem)] leading-[1.45] text-[#151c36] font-normal mt-7 max-[640px]:text-[1.1rem]">
