...
const AISWITCHFrameworkBanner = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-2 max-[800px]:grid-cols-1 gap-16 max-[800px]:gap-8 items-stretch">
        
        <div 
          data-inview={isInView}
          className="relative pl-6 py-2 opacity-0 -translate-y-8 transition-all duration-700 ease-out data-[inview=true]:opacity-100 data-[inview=true]:translate-y-0 flex flex-col justify-center"
        >
        ...
        <div 
          data-inview={isInView}
          className="relative pl-6 py-2 opacity-0 translate-y-8 transition-all duration-700 ease-out delay-[150ms] data-[inview=true]:opacity-100 data-[inview=true]:translate-y-0 flex flex-col justify-center"
        >
          <div className="absolute left-0 top-0 bottom-0 w-[4px] bg-white rounded-full"></div>
          <h2 className="m-0 font-sans font-bold text-white leading-[1.3] text-[clamp(1.2rem,1.8vw,1.6rem)] max-[640px]:text-[1.1rem]">
