...
import heroBg from "@/assets/story board home-banner-1 hero.jpg";
import heroGraphic from "@/assets/storyboard hero.png";
...
const AISwitchStoryboardsHero = () => {
  return (
    <section className="relative w-full min-h-[560px] flex items-center pt-[100px] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-[58px] max-[1100px]:px-[34px] max-[640px]:px-[18px] grid grid-cols-[1.2fr_1fr] max-[900px]:grid-cols-1 items-center gap-12 py-16">
        ...
        <div className="relative flex justify-end max-[900px]:justify-center animate-ti-stingary" style={{ animationDelay: '0.2s' }}>
          <img 
            src={heroGraphic} 
            alt="AISWITCH Storyboards abstract graphic" 
