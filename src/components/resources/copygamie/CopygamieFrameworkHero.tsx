...
import copygamieBg from "@/assets/copygamie blue bg.jpg";
import copygamieHero from "@/assets/Copygamie hero 0-843x1536.png";

const CopygamieFrameworkHero = () => {
  return (
    <section 
      className="relative w-full min-h-[560px] flex items-center pt-[100px] overflow-hidden" 
    >
      <div 
        className="absolute inset-0 w-full h-full bg-cover bg-center brightness-75"
        style={{ backgroundImage: `url('${copygamieBg}')` }}
      />
